...
def generate_summary(file_name, top_n=5):
    ...
    outlbl.configure(text=print("Indexes of top ranked_sentence order are ", ranked_sentence,"\n","Summarize Text: \n", ". ".join(summarize_text)), fg='green')
...
d=Button(root,text='Spam Predict',command=summerize,font=('',15,'bold'))
d.place(x=300,y=450)
